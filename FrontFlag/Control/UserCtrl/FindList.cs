...
{
    public partial class FindList : UserControl
    {
        ...
        public delgDo OnPrint
        {
            ...
            {
                entPrint = value;
                ShowPrint = (entPrint == null) ? false : true;
            }
        }
        ...
        public delgGetTable OnGetExcelTable
        {
            ...
            { 
                ...
                ShowExcel = (entGetExcelTable == null) ? false : true;
            }
        }
        ...
        public delgGetTableList OnGetExcelTableList
        {
            set 
            { 
                entGetExcelTableList = value;
                ShowExcel = (entGetExcelTableList == null) ? false : true;
            }
        }
        ...
        {
            bindSrc.DataSource = new SortBindingList<T> ( list );
        }
        ...
        private delegate void dgtSizeChange();
        void Call_SizeChange ()
        {
            if ( ! fNavi.InvokeRequired )
            {
                SizeChange();
            }
            else
            {
                dgtSizeChange d = new dgtSizeChange(SizeChange);
                Invoke(d, new object[] { });
            }
        }
    ...
    public class SortBindingList<T> : BindingList<T>
    {
        ...
        public SortBindingList ( System.Collections.Generic.IList<T> list )
        {
            int n = 0;
            foreach ( T t in list )
            {

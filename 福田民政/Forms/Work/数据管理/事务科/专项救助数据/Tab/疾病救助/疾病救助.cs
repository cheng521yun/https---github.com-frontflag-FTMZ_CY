...
namespace 福田民政.Forms.Work.数据管理.事务科.临时救助.Tab
{
    ...
    {
        List<DB.Stru.事务科.专项救助_疾病救助> _lst = new List<DB.Stru.事务科.专项救助_疾病救助>();
        ...
        public void Find(string strWhere)
        {
            ...
            //设置翻页的数码。
            fl.MaxPage = BL.事务科.专项救助_疾病救助.GetPageMax(strWhere);
            ShowPage(0);
        }

        void ShowPage(int nPageNo)
        {
            _lst = BL.事务科.专项救助_疾病救助.GetPage(nPageNo, _strWhere); ;

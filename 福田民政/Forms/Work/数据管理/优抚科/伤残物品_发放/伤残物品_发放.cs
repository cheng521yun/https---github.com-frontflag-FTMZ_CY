...
using 福田民政.Forms.Work.数据管理.优抚科.伤残物品_发放;

namespace 福田民政.Forms.数据管理.优抚科
{
    public partial class 伤残物品_发放 : WorkForm
    {
        福田民政.Forms.Work.数据管理.优抚科.伤残物品_发放.Tool fTool = new Tool();
        ...
        {
            strCaption = "伤残物品 发放";
            Def.Act.Menu.Entry_数据管理_优抚科_伤残物品_发放 += Call;

...
using 福田民政.Forms.Work.数据管理.民管局.登记备案_民非.Edit;

namespace 福田民政.Forms.数据管理.民管局
{
    public partial class 登记备案_民非 : WorkForm
    {
        public 登记备案_民非()
        {
            InitializeComponent();
        ...
        {
            strCaption = "登记备案 民非";
            Def.Act.Menu.Entry_数据管理_民管局_登记备案_民非 += Call;
        ...
        private void Add()
        {
            福田民政.Forms.Work.数据管理.民管局.登记备案_民非.Edit.Edit fm = new Edit();
            fm.ShowDialog();
        }

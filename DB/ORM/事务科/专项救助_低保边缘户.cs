...
namespace DB.Orm.事务科
{
    ...
    {
        DB.DA.事务科.专项救助_低保边缘户 da = new DB.DA.事务科.专项救助_低保边缘户();
        ...
        public List<DB.Stru.事务科.专项救助_低保边缘户> Get_ByWhere( string strWhere )
        {
            ...
            lst = DB.Stru.事务科.专项救助_低保边缘户.Dt2List( ref dt );

            return lst;
        }

        public DB.Stru.事务科.专项救助_低保边缘户 GetFirst_ByWhere( string strWhere )
        {
            DB.Stru.事务科.专项救助_低保边缘户 stru = new DB.Stru.事务科.专项救助_低保边缘户();
            List<DB.Stru.事务科.专项救助_低保边缘户> list = Get_ByWhere( strWhere );
        ...
        public DB.Stru.事务科.专项救助_低保边缘户 Get_ByID( string strID )
        {
        ...
        public string Save( DB.Stru.事务科.专项救助_低保边缘户 stru )
        {
        ...
        public bool Save( List<DB.Stru.事务科.专项救助_低保边缘户> lst )
        {
            bool bRet = true;
            string strID;
            foreach ( DB.Stru.事务科.专项救助_低保边缘户 stru in lst )
            {
                strID = Save( stru );
        ...
        public void Delete( DB.Stru.事务科.专项救助_低保边缘户 stru )
        {
        ...
        public void Delete( List<DB.Stru.事务科.专项救助_低保边缘户> lst )
        {
            foreach ( DB.Stru.事务科.专项救助_低保边缘户 stru in lst )
                da.Delete_ByID( stru.ID );
        }

...
namespace DB.Orm.事务科
{
    ...
    {
        DB.DA.事务科.专项救助_疾病救助 da = new DB.DA.事务科.专项救助_疾病救助();
        ...
        public List<DB.Stru.事务科.专项救助_疾病救助> Get_ByWhere( string strWhere )
        {
            ...
            lst = DB.Stru.事务科.专项救助_疾病救助.Dt2List( ref dt );

            return lst;
        }

        public DB.Stru.事务科.专项救助_疾病救助 GetFirst_ByWhere( string strWhere )
        {
            DB.Stru.事务科.专项救助_疾病救助 stru = new DB.Stru.事务科.专项救助_疾病救助();
            List<DB.Stru.事务科.专项救助_疾病救助> list = Get_ByWhere( strWhere );
        ...
        public DB.Stru.事务科.专项救助_疾病救助 Get_ByID( string strID )
        {
        ...
        public string Save( DB.Stru.事务科.专项救助_疾病救助 stru )
        {
        ...
        public bool Save( List<DB.Stru.事务科.专项救助_疾病救助> lst )
        {
            bool bRet = true;
            string strID;
            foreach ( DB.Stru.事务科.专项救助_疾病救助 stru in lst )
            {
                strID = Save( stru );
        ...
        public void Delete( DB.Stru.事务科.专项救助_疾病救助 stru )
        {
        ...
        public void Delete( List<DB.Stru.事务科.专项救助_疾病救助> lst )
        {
            foreach ( DB.Stru.事务科.专项救助_疾病救助 stru in lst )
                da.Delete_ByID( stru.ID );
        }

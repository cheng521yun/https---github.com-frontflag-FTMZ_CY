...
namespace DB.Orm.事务科
{
    ...
    {
        DB.DA.事务科.低收入居民_发放记录 da = new DB.DA.事务科.低收入居民_发放记录();
        ...
        public List<DB.Stru.事务科.低收入居民_发放记录> Get_ByWhere( string strWhere )
        {
            ...
            lst = DB.Stru.事务科.低收入居民_发放记录.Dt2List( ref dt );

            return lst;
        }

        public DB.Stru.事务科.低收入居民_发放记录 GetFirst_ByWhere( string strWhere )
        {
            DB.Stru.事务科.低收入居民_发放记录 stru = new DB.Stru.事务科.低收入居民_发放记录();
            List<DB.Stru.事务科.低收入居民_发放记录> list = Get_ByWhere( strWhere );
        ...
        public DB.Stru.事务科.低收入居民_发放记录 Get_ByID( string strID )
        {
        ...
        public string Save( DB.Stru.事务科.低收入居民_发放记录 stru )
        {
        ...
        public bool Save( List<DB.Stru.事务科.低收入居民_发放记录> lst )
        {
            bool bRet = true;
            string strID;
            foreach ( DB.Stru.事务科.低收入居民_发放记录 stru in lst )
            {
                strID = Save( stru );
        ...
        public void Delete( DB.Stru.事务科.低收入居民_发放记录 stru )
        {
        ...
        public void Delete( List<DB.Stru.事务科.低收入居民_发放记录> lst )
        {
            foreach ( DB.Stru.事务科.低收入居民_发放记录 stru in lst )
                da.Delete_ByID( stru.ID );
        }

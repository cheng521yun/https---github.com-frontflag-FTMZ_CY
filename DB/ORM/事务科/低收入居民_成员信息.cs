...
namespace DB.Orm.事务科
{
    ...
    {
        DB.DA.事务科.低收入居民_成员信息 da = new DB.DA.事务科.低收入居民_成员信息();
        ...
        public List<DB.Stru.事务科.低收入居民_成员信息> Get_ByWhere( string strWhere )
        {
            ...
            lst = DB.Stru.事务科.低收入居民_成员信息.Dt2List( ref dt );

            return lst;
        }

        public DB.Stru.事务科.低收入居民_成员信息 GetFirst_ByWhere( string strWhere )
        {
            DB.Stru.事务科.低收入居民_成员信息 stru = new DB.Stru.事务科.低收入居民_成员信息();
            List<DB.Stru.事务科.低收入居民_成员信息> list = Get_ByWhere( strWhere );
        ...
        public DB.Stru.事务科.低收入居民_成员信息 Get_ByID( string strID )
        {
        ...
        public string Save( DB.Stru.事务科.低收入居民_成员信息 stru )
        {
        ...
        public bool Save( List<DB.Stru.事务科.低收入居民_成员信息> lst )
        {
            bool bRet = true;
            string strID;
            foreach ( DB.Stru.事务科.低收入居民_成员信息 stru in lst )
            {
                strID = Save( stru );
        ...
        public void Delete( DB.Stru.事务科.低收入居民_成员信息 stru )
        {
        ...
        public void Delete( List<DB.Stru.事务科.低收入居民_成员信息> lst )
        {
            foreach ( DB.Stru.事务科.低收入居民_成员信息 stru in lst )
                da.Delete_ByID( stru.ID );
        }

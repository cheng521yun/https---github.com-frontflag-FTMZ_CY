...
namespace DB.Orm.优抚科
{
    public class 优抚资金发放
    {
        DB.DA.优抚科.优抚资金发放 da = new DB.DA.优抚科.优抚资金发放();
        ...
        public List<DB.Stru.优抚科.优抚资金发放> Get_ByWhere( string strWhere )
        {
            ...
            lst = DB.Stru.优抚科.优抚资金发放.Dt2List( ref dt );

            return lst;
        }

        public DB.Stru.优抚科.优抚资金发放 GetFirst_ByWhere( string strWhere )
        {
            DB.Stru.优抚科.优抚资金发放 stru = new DB.Stru.优抚科.优抚资金发放();
            List<DB.Stru.优抚科.优抚资金发放> list = Get_ByWhere( strWhere );
        ...
        public DB.Stru.优抚科.优抚资金发放 Get_ByID( string strID )
        {
        ...
        public List<DB.Stru.优抚科.优抚资金发放> GetPage( int nPageNo, string strWhere )
        {
            List<DB.Stru.优抚科.优抚资金发放> lst = new List<DB.Stru.优抚科.优抚资金发放>();
        ...
        public string Save( DB.Stru.优抚科.优抚资金发放 stru )
        {
        ...
        public bool Save( List<DB.Stru.优抚科.优抚资金发放> lst )
        {
            bool bRet = true;
            string strID;
            foreach ( DB.Stru.优抚科.优抚资金发放 stru in lst )
            {
                strID = Save( stru );
        ...
        public void Delete( DB.Stru.优抚科.优抚资金发放 stru )
        {
        ...
        public void Delete( List<DB.Stru.优抚科.优抚资金发放> lst )
        {
            foreach ( DB.Stru.优抚科.优抚资金发放 stru in lst )
                da.Delete_ByID( stru.ID );
        }
        ...
        //public void FakeDelete( DB.Stru.优抚科.优抚资金发放 stru )
        //{
        ...
        //public void FakeDelete( List<DB.Stru.优抚科.优抚资金发放> lst )
        //{
        //    foreach ( DB.Stru.优抚科.优抚资金发放 stru in lst )
        //        da.FakeDelete_ByID( stru.ID );
        //}

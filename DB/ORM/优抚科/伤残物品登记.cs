...
namespace DB.Orm.优抚科
{
    public class 伤残物品登记
    {
        DB.DA.优抚科.伤残物品登记 da = new DB.DA.优抚科.伤残物品登记();
        ...
        public List<DB.Stru.优抚科.伤残物品登记> Get_ByWhere( string strWhere )
        {
            ...
            lst = DB.Stru.优抚科.伤残物品登记.Dt2List( ref dt );
        ...
        public DB.Stru.优抚科.伤残物品登记 Get_ByID( string strID )
        {
        ...
        public List<DB.Stru.优抚科.伤残物品登记> GetPage( int nPageNo, string strWhere )
        {
            List<DB.Stru.优抚科.伤残物品登记> lst = new List<DB.Stru.优抚科.伤残物品登记>();
        ...
        public string Save( DB.Stru.优抚科.伤残物品登记 stru )
        {
        ...
        public bool Save( List<DB.Stru.优抚科.伤残物品登记> lst )
        {
            bool bRet = true;
            string strID;
            foreach ( DB.Stru.优抚科.伤残物品登记 stru in lst )
            {
                strID = Save( stru );
        ...
        public void Delete( DB.Stru.优抚科.伤残物品登记 stru )
        {
        ...
        public void Delete( List<DB.Stru.优抚科.伤残物品登记> lst )
        {
            foreach ( DB.Stru.优抚科.伤残物品登记 stru in lst )
                da.Delete_ByID( stru.ID );
        }
        ...
        public void FakeDelete( DB.Stru.优抚科.伤残物品登记 stru )
        {
        ...
        public void FakeDelete( List<DB.Stru.优抚科.伤残物品登记> lst )
        {
            foreach ( DB.Stru.优抚科.伤残物品登记 stru in lst )
                da.FakeDelete_ByID( stru.ID );
        }

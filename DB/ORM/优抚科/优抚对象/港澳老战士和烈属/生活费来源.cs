...
namespace DB.Orm.优抚科.优抚对象.港澳老战士和烈属
{
    public class 生活费来源
    {
        DB.DA.优抚科.优抚对象.港澳老战士和烈属.生活费来源 da = new DB.DA.优抚科.优抚对象.港澳老战士和烈属.生活费来源();
        ...
        public List<DB.Stru.优抚科.优抚对象.港澳老战士和烈属.生活费来源> Get_ByWhere( string strWhere )
        {
            ...
            lst = DB.Stru.优抚科.优抚对象.港澳老战士和烈属.生活费来源.Dt2List( ref dt );
        ...
        public DB.Stru.优抚科.优抚对象.港澳老战士和烈属.生活费来源 Get_ByID( string strID )
        {
        ...
        public List<DB.Stru.优抚科.优抚对象.港澳老战士和烈属.生活费来源> GetPage( int nPageNo, string strWhere )
        {
            List<DB.Stru.优抚科.优抚对象.港澳老战士和烈属.生活费来源> lst = new List<DB.Stru.优抚科.优抚对象.港澳老战士和烈属.生活费来源>();
        ...
        public string Save( DB.Stru.优抚科.优抚对象.港澳老战士和烈属.生活费来源 stru )
        {
        ...
        public bool Save( List<DB.Stru.优抚科.优抚对象.港澳老战士和烈属.生活费来源> lst )
        {
            bool bRet = true;
            string strID;
            foreach ( DB.Stru.优抚科.优抚对象.港澳老战士和烈属.生活费来源 stru in lst )
            {
                strID = Save( stru );
        ...
        public void Delete( DB.Stru.优抚科.优抚对象.港澳老战士和烈属.生活费来源 stru )
        {
        ...
        public void Delete( List<DB.Stru.优抚科.优抚对象.港澳老战士和烈属.生活费来源> lst )
        {
            foreach ( DB.Stru.优抚科.优抚对象.港澳老战士和烈属.生活费来源 stru in lst )
                da.Delete_ByID( stru.ID );
        }
        ...
        public void FakeDelete( DB.Stru.优抚科.优抚对象.港澳老战士和烈属.生活费来源 stru )
        {
        ...
        public void FakeDelete( List<DB.Stru.优抚科.优抚对象.港澳老战士和烈属.生活费来源> lst )
        {
            foreach ( DB.Stru.优抚科.优抚对象.港澳老战士和烈属.生活费来源 stru in lst )
                da.FakeDelete_ByID( stru.ID );
        }

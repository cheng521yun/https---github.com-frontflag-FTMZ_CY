...
namespace DB.DA.优抚科.优抚对象.铀矿开采军队退役人员
{
    class 基本信息
    {
        ...
        public DataTable GetWhere( string strWhere )
        {
            ...
            string strSql = String.Format( "select * from {0} {1} order by ID desc", DB.Tab.优抚科.优抚对象.铀矿开采军队退役人员员子女役人员.基本信息.TAB, strWhere );
        ...
        public int GetPageMax( string strWhere )
        {
            ...
            int nPageNum = Sql.GetPageMaxPage( DB.Tab.优抚科.优抚对象.铀矿开采军队退役人员员子女役人员.基本信息.TAB, strWhere, ref nRecCount, CONST.PageSize );
        ...
        public bool FakeDelete_Where( string strWhere )
        {
            ...
            string strSql = String.Format( "update {0} set {1}='True' where {2}", DB.Tab.优抚科.优抚对象.铀矿开采军队退役人员员子女役人员.基本信息.TAB, DB.Tab.优抚科.优抚对象.铀矿开采军队退役人员员子女役人员.基本信息.DelFlag, strWhere );
            Sql.Exec( strSql );
        ...
        public DataTable GetCount( string strWhere )
        {
            ...
            string strSql = String.Format( "select Count(*) from {0} {1} ", DB.Tab.优抚科.优抚对象.铀矿开采军队退役人员员子女役人员.基本信息.TAB, strWhere );
            dt = Sql.ExecDataTable( strSql );
        ...
        public DataTable GetSum( string strFld, string strWhere )
        {
            ...
            string strSql = String.Format( "select Sum({2}) from {0} {1} ", DB.Tab.优抚科.优抚对象.铀矿开采军队退役人员员子女役人员.基本信息.TAB, strWhere, strFld );
            dt = Sql.ExecDataTable( strSql );

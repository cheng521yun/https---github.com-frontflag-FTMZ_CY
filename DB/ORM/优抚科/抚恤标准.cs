...
namespace DB.Orm.优抚科
{
    public class 抚恤标准
    {
        DB.DA.优抚科.抚恤标准 da = new DB.DA.优抚科.抚恤标准();
        ...
        public List<DB.Stru.优抚科.抚恤标准> Get_ByWhere( string strWhere )
        {
            ...
            lst = DB.Stru.优抚科.抚恤标准.Dt2List( ref dt );

            return lst;
        }

        public DB.Stru.优抚科.抚恤标准 GetFirst_ByWhere( string strWhere )
        {
            DB.Stru.优抚科.抚恤标准 stru = new DB.Stru.优抚科.抚恤标准();
            List<DB.Stru.优抚科.抚恤标准> list = Get_ByWhere( strWhere );
        ...
        public DB.Stru.优抚科.抚恤标准 Get_ByID( string strID )
        {
        ...
        public List<DB.Stru.优抚科.抚恤标准> GetPage( int nPageNo, string strWhere )
        {
            List<DB.Stru.优抚科.抚恤标准> lst = new List<DB.Stru.优抚科.抚恤标准>();
        ...
        public string Save( DB.Stru.优抚科.抚恤标准 stru )
        {
        ...
        public bool Save( List<DB.Stru.优抚科.抚恤标准> lst )
        {
            bool bRet = true;
            string strID;
            foreach ( DB.Stru.优抚科.抚恤标准 stru in lst )
            {
                strID = Save( stru );
        ...
        public void Delete( DB.Stru.优抚科.抚恤标准 stru )
        {
        ...
        public void Delete( List<DB.Stru.优抚科.抚恤标准> lst )
        {
            foreach ( DB.Stru.优抚科.抚恤标准 stru in lst )
                da.Delete_ByID( stru.ID );
        }
        ...
        //public void FakeDelete( DB.Stru.优抚科.抚恤标准 stru )
        //{
        ...
        //public void FakeDelete( List<DB.Stru.优抚科.抚恤标准> lst )
        //{
        //    foreach ( DB.Stru.优抚科.抚恤标准 stru in lst )
        //        da.FakeDelete_ByID( stru.ID );
        //}

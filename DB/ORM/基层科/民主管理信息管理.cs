...
namespace DB.Orm.基层科
{
    ...
    {
        DB.DA.基层科.民主管理信息管理 da = new DB.DA.基层科.民主管理信息管理();
        ...
        public List<DB.Stru.基层科.民主管理信息管理> Get_ByWhere(string strWhere)
        {
            ...
            lst = DB.Stru.基层科.民主管理信息管理.Dt2List(ref dt);
        ...
        public DB.Stru.基层科.民主管理信息管理 Get_ByID(string strID)
        {
        ...
        public string Save(DB.Stru.基层科.民主管理信息管理 stru)
        {
        ...
        public bool Save(List<DB.Stru.基层科.民主管理信息管理> lst)
        {
            bool bRet = true;
            string strID;
            foreach (DB.Stru.基层科.民主管理信息管理 stru in lst)
            {
                strID = Save(stru);
        ...
        public void Delete(DB.Stru.基层科.民主管理信息管理 stru)
        {
        ...
        public void Delete(List<DB.Stru.基层科.民主管理信息管理> lst)
        {
            foreach (DB.Stru.基层科.民主管理信息管理 stru in lst)
                da.Delete_ByID(stru.ID);
        }

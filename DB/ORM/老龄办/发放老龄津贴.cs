...
namespace DB.Orm.老龄办
{
    public class 发放老龄津贴
    {
        DB.DA.老龄办.发放老龄津贴 da = new DB.DA.老龄办.发放老龄津贴();
        ...
        public List<DB.Stru.老龄办.发放老龄津贴> Get_ByWhere( string strWhere )
        {
            ...
            lst = DB.Stru.老龄办.发放老龄津贴.Dt2List( ref dt );
        ...
        public DB.Stru.老龄办.发放老龄津贴 Get_ByID( string strID )
        {
        ...
        public string Save( DB.Stru.老龄办.发放老龄津贴 stru )
        {
        ...
        public bool Save( List<DB.Stru.老龄办.发放老龄津贴> lst )
        {
            bool bRet = true;
            string strID;
            foreach ( DB.Stru.老龄办.发放老龄津贴 stru in lst )
            {
                strID = Save( stru );
        ...
        public void Delete( DB.Stru.老龄办.发放老龄津贴 stru )
        {
        ...
        public void Delete( List<DB.Stru.老龄办.发放老龄津贴> lst )
        {
            foreach ( DB.Stru.老龄办.发放老龄津贴 stru in lst )
                da.Delete_ByID( stru.ID );
        }
        ...
        public void FakeDelete( DB.Stru.老龄办.发放老龄津贴 stru )
        {
        ...
        public void FakeDelete( List<DB.Stru.老龄办.发放老龄津贴> lst )
        {
            foreach ( DB.Stru.老龄办.发放老龄津贴 stru in lst )
                da.FakeDelete_ByID( stru.ID );
        }

...
namespace DB.Orm.老龄办
{
    public partial class 老龄津贴统计
    {
        ...
        public List<DB.Stru.老龄办.老龄津贴统计> Get_ByWhere( string strWhere )
        {
            ...
            lst = DB.Stru.老龄办.老龄津贴统计.Dt2List( ref dt );

            return lst;
        }

        public DB.Stru.老龄办.老龄津贴统计 GetFirst_ByWhere( string strWhere )
        {
            DB.Stru.老龄办.老龄津贴统计 stru = new DB.Stru.老龄办.老龄津贴统计();
            List<DB.Stru.老龄办.老龄津贴统计> list = Get_ByWhere( strWhere );
        ...
        public DB.Stru.老龄办.老龄津贴统计 Get_ByID( string strID )
        {
        ...
        public List<DB.Stru.老龄办.老龄津贴统计> GetPage( int nPageNo, string strWhere )
        {
            List<DB.Stru.老龄办.老龄津贴统计> lst = new List<DB.Stru.老龄办.老龄津贴统计>();
        ...
        public string Save( DB.Stru.老龄办.老龄津贴统计 stru )
        {
        ...
        public bool Save( List<DB.Stru.老龄办.老龄津贴统计> lst )
        {
            bool bRet = true;
            string strID;
        ...
        public void Delete( DB.Stru.老龄办.老龄津贴统计 stru )
        {
        ...
        public void Delete( List<DB.Stru.老龄办.老龄津贴统计> lst )
        {
            foreach ( DB.Stru.老龄办.老龄津贴统计 stru in lst )
                da.Delete_ByID( stru.ID );
        }

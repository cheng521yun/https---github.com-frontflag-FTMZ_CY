...
namespace DB.Orm.事务科
{
    ...
    {
        DB.DA.事务科.居家养老服务补贴 da = new DB.DA.事务科.居家养老服务补贴();
        ...
        public List<DB.Stru.事务科.居家养老服务补贴> Get_ByWhere(string strWhere)
        {
            ...
            lst = DB.Stru.事务科.居家养老服务补贴.Dt2List(ref dt);

            return lst;
        }

        public DB.Stru.事务科.居家养老服务补贴 GetFirst_ByWhere(string strWhere)
        {
            DB.Stru.事务科.居家养老服务补贴 stru = new DB.Stru.事务科.居家养老服务补贴();
            List<DB.Stru.事务科.居家养老服务补贴> list = Get_ByWhere(strWhere);
        ...
        public DB.Stru.事务科.居家养老服务补贴 Get_ByID(string strID)
        {
        ...
        public string Save(DB.Stru.事务科.居家养老服务补贴 stru)
        {
        ...
        public bool Save(List<DB.Stru.事务科.居家养老服务补贴> lst)
        {
            bool bRet = true;
            string strID;
            foreach (DB.Stru.事务科.居家养老服务补贴 stru in lst)
            {
                strID = Save(stru);
        ...
        public void Delete(DB.Stru.事务科.居家养老服务补贴 stru)
        {
        ...
        public void Delete(List<DB.Stru.事务科.居家养老服务补贴> lst)
        {
            foreach (DB.Stru.事务科.居家养老服务补贴 stru in lst)
                da.Delete_ByID(stru.ID);
        }

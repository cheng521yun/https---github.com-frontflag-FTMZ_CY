...
namespace DB.Orm.老龄办
{
    public class 敬老优待证
    {
        ...
        public List<DB.Stru.老龄办.敬老优待证> Get_ByWhere( string strWhere )
        {
            ...
            lst = DB.Stru.老龄办.敬老优待证.Dt2List( ref dt );
        ...
        public DB.Stru.老龄办.敬老优待证 Get_ByID( string strID )
        {
        ...
        public string Save( DB.Stru.老龄办.敬老优待证 stru )
        {
        ...
        public bool Save( List<DB.Stru.老龄办.敬老优待证> lst )
        {
            bool bRet = true;
            string strID;
            foreach ( DB.Stru.老龄办.敬老优待证 stru in lst )
            {
                strID = Save( stru );
        ...
        public void Delete( DB.Stru.老龄办.敬老优待证 stru )
        {
        ...
        public void Delete( List<DB.Stru.老龄办.敬老优待证> lst )
        {
            foreach ( DB.Stru.老龄办.敬老优待证 stru in lst )
                da.Delete_ByID( stru.ID );
        }
        ...
        public void FakeDelete( DB.Stru.老龄办.敬老优待证 stru )
        {
        ...
        public void FakeDelete( List<DB.Stru.老龄办.敬老优待证> lst )
        {
            foreach ( DB.Stru.老龄办.敬老优待证 stru in lst )
                da.FakeDelete_ByID( stru.ID );
        }

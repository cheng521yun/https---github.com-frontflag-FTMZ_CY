...
namespace DB.Stru
{
    public partial class USER
    {
        ...
        public string GranderStr
        {
            get { return (_Grander == "True") ? "男" : "女"; }
        }
        ...
        public bool Dr2Stru( DataRow dr )
        {
            ...
            Role = dr[ Tab.USER.Role ].ToString().Trim();
            Department = dr[ Tab.USER.Department ].ToString().Trim();
        ...
        public void Stru2Dr( ref DataRow dr )
        {
            ...
            dr[ Tab.USER.Role ] = Role ;
            dr[ Tab.USER.Department ] = Department ;
        }
        ...
        public void CopyFrom( USER struFrom )
        {
            ...
            Role = struFrom.Status;
            Department = struFrom.Department;
        }

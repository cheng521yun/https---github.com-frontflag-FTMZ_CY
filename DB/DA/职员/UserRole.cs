...
namespace DB.DA
{
    class USERROLE
    {
        public DataTable GetBlank()
        {
            ...
            DataTable dt = Sql.GetBlankDt( Tab.USERROLE.TAB );
            Sql.Close();
            return dt;
        }
        ...
        public DataTable GetWhere( string strWhere )
        {
            ...
            string strSql = String.Format( "select * from {0} {1} order by ID desc", Tab.USERROLE.TAB, strWhere );
        ...
        public DataTable GetPage( int nPageNo, string strWhere )
        {
            ...
            DataTable dt = new DataTable();
            string strSql = SQL.GetPageSql2005( Tab.USERROLE.TAB, nPageNo, CONST.PageSize, Tab.USERROLE.ID, strWhere, false );
            dt = Sql.ExecDataTable( strSql );
        ...
        public int GetPageMax( string strWhere )
        {
            ...
            int nPageNum = Sql.GetPageMaxPage( Tab.USERROLE.TAB, strWhere, ref nRecCount, CONST.PageSize );
        ...
        public void Delete_Table()
        {
            ...
            string strSql = String.Format( "delete from {0} ", Tab.USERROLE.TAB );
            Sql.Exec( strSql );
        ...
        public bool Delete_Where( string strWhere )
        {
            ...
            string strSql = String.Format( "delete from {0} where {1}", Tab.USERROLE.TAB, strWhere );
            Sql.Exec( strSql );
        ...
        //    string strSql = String.Format( "update {0} set {1}='True' where {2}", Tab.USERROLE.TAB, Tab.USERROLE.DelFlag, strWhere );
        //    Sql.Exec( strSql );
        ...
        public void Update_ByID( string strID, string strFld, string strVal )
        {
            ...
            string strSql = String.Format( "update {0} set {1}='{2}' where ID='{3}'", Tab.USERROLE.TAB, strFld, strVal, strID );
            Sql.Exec( strSql );
        ...
        public DataTable GetCount( string strWhere )
        {
            ...
            string strSql = String.Format( "select Count(*) from {0} {1} ", Tab.USERROLE.TAB, strWhere );
            dt = Sql.ExecDataTable( strSql );
        ...
        public DataTable GetSum( string strFld, string strWhere )
        {
            ...
            string strSql = String.Format( "select Sum({2}) from {0} {1} ", Tab.USERROLE.TAB, strWhere, strFld );
            dt = Sql.ExecDataTable( strSql );

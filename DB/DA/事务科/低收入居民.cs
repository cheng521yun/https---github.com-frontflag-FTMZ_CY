...
namespace DB.DA.事务科
{
    class 低收入居民
    {
        ...
        public void Delete_Table()
        {
            ...
            string strSql = String.Format( "delete from {0} ", DB.Tab.事务科.低收入居民.TAB );
            Sql.Exec( strSql );
        ...
        public bool Delete_Where( string strWhere )
        {
            ...
            string strSql = String.Format( "delete from {0} where {1}", DB.Tab.事务科.低收入居民.TAB, strWhere );
            Sql.Exec( strSql );
        ...
        public DataTable GetCount( string strWhere )
        {
            ...
            string strSql = String.Format( "select Count(*) from {0} {1} ", DB.Tab.事务科.低收入居民.TAB, strWhere );
            dt = Sql.ExecDataTable( strSql );
        ...
        public DataTable GetSum( string strFld, string strWhere )
        {
            ...
            string strSql = String.Format( "select Sum({2}) from {0} {1} ", DB.Tab.事务科.低收入居民.TAB, strWhere, strFld );
            dt = Sql.ExecDataTable( strSql );

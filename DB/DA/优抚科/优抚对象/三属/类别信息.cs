...
namespace DB.Orm.优抚科.优抚对象.三属
{
    public class 类别信息
    {
        DB.DA.优抚科.优抚对象.三属.类别信息 da = new DB.DA.优抚科.优抚对象.三属.类别信息();
        ...
        public List<DB.Stru.优抚科.优抚对象.三属.类别信息> Get_ByWhere( string strWhere )
        {
            ...
            lst = DB.Stru.优抚科.优抚对象.三属.类别信息.Dt2List( ref dt );

            return lst;
        }

        public DB.Stru.优抚科.优抚对象.三属.类别信息 GetFirst_ByWhere( string strWhere )
        {
            DB.Stru.优抚科.优抚对象.三属.类别信息 stru = new DB.Stru.优抚科.优抚对象.三属.类别信息();
            List<DB.Stru.优抚科.优抚对象.三属.类别信息> list = Get_ByWhere( strWhere );
        ...
        public DB.Stru.优抚科.优抚对象.三属.类别信息 Get_ByID( string strID )
        {
        ...
        public List<DB.Stru.优抚科.优抚对象.三属.类别信息> GetPage( int nPageNo, string strWhere )
        {
            List<DB.Stru.优抚科.优抚对象.三属.类别信息> lst = new List<DB.Stru.优抚科.优抚对象.三属.类别信息>();
        ...
        public string Save( DB.Stru.优抚科.优抚对象.三属.类别信息 stru )
        {
        ...
        public bool Save( List<DB.Stru.优抚科.优抚对象.三属.类别信息> lst )
        {
            bool bRet = true;
            string strID;
            foreach ( DB.Stru.优抚科.优抚对象.三属.类别信息 stru in lst )
            {
                strID = Save( stru );
        ...
        public void Delete( DB.Stru.优抚科.优抚对象.三属.类别信息 stru )
        {
        ...
        public void Delete( List<DB.Stru.优抚科.优抚对象.三属.类别信息> lst )
        {
            foreach ( DB.Stru.优抚科.优抚对象.三属.类别信息 stru in lst )
                da.Delete_ByID( stru.ID );
        }
        ...
        public void FakeDelete( DB.Stru.优抚科.优抚对象.三属.类别信息 stru )
        {
        ...
        public void FakeDelete( List<DB.Stru.优抚科.优抚对象.三属.类别信息> lst )
        {
            foreach ( DB.Stru.优抚科.优抚对象.三属.类别信息 stru in lst )
                da.FakeDelete_ByID( stru.ID );
        }

...
namespace DB.DA.优抚科.优抚对象.在乡复员军人
{
    class 生活费来源
    {
        ...
        public DataTable GetWhere( string strWhere )
        {
            ...
            string strSql = String.Format( "select * from {0} {1} order by ID desc", DB.Tab.优抚科.优抚对象.在乡复员军人.生活费来源.TAB, strWhere );
        ...
        public DataTable GetPage( int nPageNo, string strWhere )
        {
            ...
            DataTable dt = new DataTable();
            string strSql = SQL.GetPageSql2005( DB.Tab.优抚科.优抚对象.在乡复员军人.生活费来源.TAB, nPageNo, CONST.PageSize, DB.Tab.优抚科.优抚对象.在乡复员军人.生活费来源.ID, strWhere, false );
            dt = Sql.ExecDataTable( strSql );
        ...
        public int GetPageMax( string strWhere )
        {
            ...
            int nPageNum = Sql.GetPageMaxPage( DB.Tab.优抚科.优抚对象.在乡复员军人.生活费来源.TAB, strWhere, ref nRecCount, CONST.PageSize );
        ...
        public bool Delete_Where( string strWhere )
        {
            ...
            string strSql = String.Format( "delete from {0} where {1}", DB.Tab.优抚科.优抚对象.在乡复员军人.生活费来源.TAB, strWhere );
            Sql.Exec( strSql );
        ...
        public void Update_ByID( string strID, string strFld, string strVal )
        {
            ...
            string strSql = String.Format( "update {0} set {1}='{2}' where ID='{3}'", DB.Tab.优抚科.优抚对象.在乡复员军人.生活费来源.TAB, strFld, strVal, strID );
            Sql.Exec( strSql );
        ...
        public DataTable GetCount( string strWhere )
        {
            ...
            string strSql = String.Format( "select Count(*) from {0} {1} ", DB.Tab.优抚科.优抚对象.在乡复员军人.生活费来源.TAB, strWhere );
            dt = Sql.ExecDataTable( strSql );
        ...
        public DataTable GetSum( string strFld, string strWhere )
        {
            ...
            string strSql = String.Format( "select Sum({2}) from {0} {1} ", DB.Tab.优抚科.优抚对象.在乡复员军人.生活费来源.TAB, strWhere, strFld );
            dt = Sql.ExecDataTable( strSql );

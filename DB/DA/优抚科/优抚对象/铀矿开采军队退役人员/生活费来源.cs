...
namespace DB.DA.优抚科.优抚对象.铀矿开采军队退役人员
{
    class 生活费来源
    {
        public DataTable GetBlank()
        {
            ...
            DataTable dt = Sql.GetBlankDt( DB.Tab.优抚科.优抚对象.铀矿开采军队退役人员.生活费来源.TAB );
            dt.Rows.Clear();
            Sql.Close();
            return dt;
        }
        ...
        public DataTable GetWhere( string strWhere )
        {
            ...
            string strSql = String.Format( "select * from {0} {1} order by ID desc", DB.Tab.优抚科.优抚对象.铀矿开采军队退役人员.生活费来源.TAB, strWhere );
        ...
        public DataTable GetPage( int nPageNo, string strWhere )
        {
            ...
            DataTable dt = new DataTable();
            string strSql = SQL.GetPageSql2005( DB.Tab.优抚科.优抚对象.铀矿开采军队退役人员.生活费来源.TAB, nPageNo, CONST.PageSize, DB.Tab.优抚科.优抚对象.铀矿开采军队退役人员.生活费来源.ID, strWhere, false );
            dt = Sql.ExecDataTable( strSql );
        ...
        public void Delete_Table()
        {
            ...
            string strSql = String.Format( "delete from {0} ", DB.Tab.优抚科.优抚对象.铀矿开采军队退役人员.生活费来源.TAB );
            Sql.Exec( strSql );
        ...
        public bool Delete_Where( string strWhere )
        {
            ...
            string strSql = String.Format( "delete from {0} where {1}", DB.Tab.优抚科.优抚对象.铀矿开采军队退役人员.生活费来源.TAB, strWhere );
            Sql.Exec( strSql );
        ...
        public bool FakeDelete_Where( string strWhere )
        {
            ...
            string strSql = String.Format( "update {0} set {1}='True' where {2}", DB.Tab.优抚科.优抚对象.铀矿开采军队退役人员.生活费来源.TAB, DB.Tab.优抚科.优抚对象.铀矿开采军队退役人员.生活费来源.DelFlag, strWhere );
            Sql.Exec( strSql );
        ...
        public void Update_ByID( string strID, string strFld, string strVal )
        {
            ...
            string strSql = String.Format( "update {0} set {1}='{2}' where ID='{3}'", DB.Tab.优抚科.优抚对象.铀矿开采军队退役人员.生活费来源.TAB, strFld, strVal, strID );
            Sql.Exec( strSql );
        ...
        public DataTable GetSum( string strFld, string strWhere )
        {
            ...
            string strSql = String.Format( "select Sum({2}) from {0} {1} ", DB.Tab.优抚科.优抚对象.铀矿开采军队退役人员.生活费来源.TAB, strWhere, strFld );
            dt = Sql.ExecDataTable( strSql );

...
namespace Def.Command
{
    public class Menu
    {
        ...
        static public int 数据管理_老龄办 = 2010;
            ...
            static public int 数据管理_老龄办_老龄津贴_统计 = 201050;
            

            static public int 数据管理_老龄办_老龄津贴_发放_执行发放 = 201031;
            static public int 数据管理_老龄办_老龄津贴_发放_执行停发 = 201032;
            static public int 数据管理_老龄办_老龄津贴_发放_查询 = 201033;


        //数据管理 民管局
        static public int 数据管理_民管局 = 2020;
            static public int 数据管理_民管局_登记备案_民非 = 202010;
            static public int 数据管理_民管局_登记备案_社团 = 202020;
            static public int 数据管理_民管局_注销备案_民非 = 202030;
            static public int 数据管理_民管局_注销备案_社团 = 202040;
            static public int 数据管理_民管局_台账列表 = 202050;
            static public int 数据管理_民管局_台账统计 = 202060;

        //数据管理 事务科
        static public int 数据管理_事务科 = 2030;
        static public int 数据管理_事务科_低收入居民数据 = 203010;
        static public int 数据管理_事务科_专项救助数据 = 203020;
        ...
        //系统配置
        static public int 系统配置_用户管理 = 5010;
        static public int 系统配置_权限管理 = 5020;
        static public int 系统配置_参数管理 = 5030;
        ...
        //数据交换
        static public int 数据交换_Excel方式 = 7010;
        static public int 数据交换_前置机方式 = 7020;
